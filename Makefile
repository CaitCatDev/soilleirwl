...
includes/private/xdg-output-unstable-v1-server.h:
	$(WAYLAND_SCANNER) server-header $(WAYLAND_DIR)/unstable/xdg-output/xdg-output-unstable-v1.xml $@

src/xdg-output-unstable-v1.c:
	$(WAYLAND_SCANNER) private-code $(WAYLAND_DIR)/unstable/xdg-output/xdg-output-unstable-v1.xml $@
